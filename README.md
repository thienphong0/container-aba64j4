...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-aba64j4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-aba64j4.containers.anotherwebservice.com/
...
```
git clone git@github.com:thienphong0/container-aba64j4.git
cd container-aba64j4
```
...
```
docker attach container-aba64j4
```
